...
import deo.github.com.data.service.CrmService;
import deo.github.com.views.MainLayout;
...
public class ListView extends VerticalLayout {
    ...
    public ListView(CrmService service) {
        ...
        form = new ContactForm(service.findAllProducts(), service.findAllStatuses());
        form.setWidth("25em");
    ...
    private void configureGrid() {
        ...
        grid.addColumn(contact -> contact.getProduct().getName()).setHeader("Product");
